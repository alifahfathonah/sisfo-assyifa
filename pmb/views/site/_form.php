...
<?php $form = ActiveForm::begin(['options' => ['enctype' => 'multipart/form-data']]); ?>
    ...
    <div class="form-group">
        ...
        <input type="text" value="2021" class="form-control" readonly>
    </div>

    <div class="form-group">
        <label for="">Jalur Pendaftaran</label>
        <input type="text" value="Seleksi Mandiri PTS" class="form-control" readonly>
    </div>
