...
/**
 * This is the model class for table "detail_penugasan_dosen".
 *
 * @property int $id
 ...
 */
class DetailPenugasanDosen extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['id_registrasi_dosen', 'id_tahun_ajaran', 'nama_tahun_ajaran', 'id_perguruan_tinggi', 'nama_perguruan_tinggi', 'nidn', 'id_dosen', 'nama_dosen', 'id_prodi', 'nama_program_studi', 'nomor_surat_tugas', 'tanggal_surat_tugas', 'mulai_surat_tugas'], 'string', 'max' => 255],
        ];
    }
