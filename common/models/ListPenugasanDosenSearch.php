...
/**
 * ListPenugasanDosenSearch represents the model behind the search form of `common\models\ListPenugasanDosen`.
 */
class ListPenugasanDosenSearch extends ListPenugasanDosen
{
    /**
     * {@inheritdoc}
     */
    public function rules()
    {
        return [
            [['id'], 'integer'],
            [['id_registrasi_dosen', 'id_dosen', 'nama_dosen', 'nidn', 'id_tahun_ajaran', 'nama_tahun_ajaran', 'id_perguruan_tinggi', 'nama_perguruan_tinggi', 'id_prodi', 'nama_program_studi', 'nomor_surat_tugas', 'tanggal_surat_tugas', 'mulai_surat_tugas'], 'safe'],
        ];
    }
